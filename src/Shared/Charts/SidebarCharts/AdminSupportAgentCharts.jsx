...
import { configuration } from './areaChartThemeConfiguration';
import SortDay from '../../Sort/SortDay';

const AdminSupportAgentCharts = () => {
  ...
  return (
    <div className='p-[22px]'>
        <div className='flex items-center justify-between mb-5 gap-2 flex-wrap'>
            <h2 className=' text-[23px] text-[#3D4854] font-[500]'>Top Support Agents</h2>
...
export default AdminSupportAgentCharts