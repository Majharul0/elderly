...
import AdminAlertsProgressBox from './AdminAlertsProgressBox';
import { adminAlertsData } from '../../../../assets/admin/data';

const AdminAlertsCharts = () => {
...
const config = {
  ...
  return (
    <div className='py-4 px-[22px] h-full w-full'>
        <h2 className=' text-[23px] text-secondary font-[500]'>Alerts</h2>
        <div className='h-[185px] w-full mt-[30px]'>
            <Line {...config} />
        </div>
        <div className='mt-4 bg-[#EEEEEE] w-full h-[1px]'>

        </div>


        <div className='w-full px-5'>
            <AdminAlertsProgressBox data2={adminAlertsData}/>
        </div>
    </div>
  );
};

export default AdminAlertsCharts;
