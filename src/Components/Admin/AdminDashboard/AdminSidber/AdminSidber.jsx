...
const AdminSidber = () => {
    ...
    const menus = [
        {
            label: 'Dashboard', path: '/admin/dashboard', icon: <Icon className=' w-5 h-5' icon="basil:chart-pie-outline" />, child: []
        },

        {
            label: 'Support Agents', path: '/admin/dashboard/Support-Agents', icon: <Icon className=' w-5 h-5' icon="basil:folder-user-outline" />, child: []
        },
            ...
            <section className='w-[280px]'>
                ...
                <div className='p-4 grid gap-1'>
                    ...
                    <NavLink to={'/admin/dashboard'}
                        className='block rounded-[10px] hover:bg-primary p-4 hover:text-white duration-150 text-[#90969D]'
                        style={(path.pathname === "/admin/dashboard"? activeStyle : undefined)}
                    >
                        <div className='flex item-center gap-2 font-bold'>
                            <span>
                    ...
                    <NavLink to={'/admin/dashboard/Support-Agents'}
                        className='block rounded-[10px] hover:bg-primary p-4 hover:text-white duration-150 text-[#90969D]'
                        style={(path.pathname.slice(0,31) === "/admin/dashboard/Support-Agents" ? activeStyle : undefined)}
                    >
                        <div className='flex item-center gap-2 font-bold'>
                            <span>
                    ...
                    <NavLink to={'/admin/dashboard/elderly'}
                        className='block rounded-[10px] hover:bg-primary p-4 hover:text-white duration-150 text-[#90969D]'
                        style={(path.pathname.slice(0,24) === "/admin/dashboard/elderly"? activeStyle : undefined)}
                    >
                        <div className='flex item-center gap-2 font-bold'>
                            <span>
                ...
                <div className='flex justify-between items-center p-4'>
                    <div className='flex gap-2 items-center'>
                        ...
                        <div>
                            ...
                            <p className='text-xs text-[#3D4854]'>Admin</p>
                        </div>
                    </div>
